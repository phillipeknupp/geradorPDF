...
# --- NOVO: Classe customizada para evitar o crash do botão direito ---
class CustomGraphicsTextItem(QGraphicsTextItem):
    def __init__(self, text, parent=None):
        super().__init__(text, parent)

    def contextMenuEvent(self, event):
        # Ignora o evento de menu de contexto (botão direito)
        # Isso impede que o PyQt tente abrir o menu padrão bugado que crasha o app.
        event.accept()


# --- NOVO: Janela "Sobre o Desenvolvedor" ---
...
class PDFPageEditor(QDialog):
    ...
    def setup_ui(self):
        ...
        # --- NOVO: Botão de remover texto ---
        btn_remove_text = QPushButton("Remover Texto")
        btn_remove_text.setStyleSheet("background-color: #A00000;")  # Cor vermelha
        ...
        toolbar.addWidget(btn_remove_text)  # Adicionado na barra de ferramentas
        toolbar.addStretch()
    ...
    def add_text_box(self):
        # --- MODIFICADO: Utilizando a nova classe para evitar crash no click direito ---
    ...
    # --- NOVO: Função que executa a remoção do texto ---
...
class PDFManagerApp(QMainWindow):
    def __init__(self):
        ...
        # Dentro do __init__ da sua classe PDFManagerApp:
    ...
    # --- NOVO: Função para exibir a tela Sobre ---
    ...
    def pdf_to_images(self):
        QMessageBox.information(self, "Info", "Funcionalidade de converter para imagens em construção.")

    def rotate_selected(self):
        QMessageBox.information(self, "Info", "Funcionalidade de rotacionar em construção.")

    def add_watermark_to_selected(self):
        QMessageBox.information(self, "Info", "Funcionalidade de Marca d'água em construção.")

    def apply_redaction(self):
        QMessageBox.information(self, "Info", "Funcionalidade de redação em construção.")

    def apply_ocr(self):
        QMessageBox.information(self, "Info", "Funcionalidade de OCR em construção.")

    def compress_pdfs(self):
        QMessageBox.information(self, "Info", "Funcionalidade de Compressão em construção.")

    def images_to_pdf(self):
        QMessageBox.information(self, "Info", "Funcionalidade Imagem -> PDF em construção.")

    def unlock_pdf(self):
        QMessageBox.information(self, "Info", "Desbloqueio em construção.")

    def lock_pdf(self):
        QMessageBox.information(self, "Info", "Bloqueio em construção.")

if __name__ == "__main__":
    app = QApplication(sys.argv)

    # Tente carregar a splash com verificação
    ...
    if os.path.exists(splash_path):
        try:
            ...
            time.sleep(1) # Pequena pausa para vermos a splash
        except Exception as e:
